<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.Master" Theme="SSAC Theme" AutoEventWireup="true" CodeBehind="RegisterPage.aspx.cs" Inherits="SSAC_Project.RegisterPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <table>
        <tr>
            <td><asp:Label ID="LblCi" skinId="lblSkin" Text="Customer Id: " runat="server"/></td>
